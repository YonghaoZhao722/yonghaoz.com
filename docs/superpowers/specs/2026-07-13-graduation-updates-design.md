...
Update the academic profile with two June 2026 announcements and align the
education and experience timelines with the graduation results.
...
Follow the existing timeline and news-card patterns. No visual redesign,
additional navigation, or new assets are required.

## Verification

- Add a focused test for the rendered graduation news and timeline text.
- Run the test, lint, and production build.
